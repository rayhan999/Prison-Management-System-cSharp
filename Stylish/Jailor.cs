...
namespace Stylish
{
    public partial class Jailor : Form
    {
        public Jailor(string UserName)
        {
            InitializeComponent();
        ...
        {
            ManagePrisoner mp = new ManagePrisoner(lblUser.Text);
            this.Hide();
            mp.Show();
        }
        ...
        private void btnCrtApp_Click(object sender, EventArgs e)
        {
            CreateApp capp = new CreateApp(lblUser.Text);
            this.Hide();
            capp.Show();
        }

        private void Jailor_Load(object sender, EventArgs e)
        {
            LoadImage();
        }
    }
